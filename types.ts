...
export type CommitType = 'feat' | 'fix' | 'docs' | 'style' | 'refactor' | 'perf' | 'test' | 'chore' | 'revert' | 'merge';
...
export interface Repository {
    ...
    branches: Record<string, Branch>; // Map branch name to Branch object
    commits: Record<string, Commit>; // Map hash to Commit
    stagedChanges?: boolean; // Flag to indicate uncommitted changes in UI
    remoteUrl?: string;
}
